...
const Page = () => {
  ...
  const fetchPendingOrders = async () => {
    try {
      const response = await fetch("https://matching-orders-2bjkwohtb-sudhanshu8257s-projects.vercel.app/api/v1/pending");
  ...
  const fetchCompletedOrders = async () => {
    try {
      const response = await fetch("https://matching-orders-2bjkwohtb-sudhanshu8257s-projects.vercel.app/api/v1/completed");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://matching-orders-2bjkwohtb-sudhanshu8257s-projects.vercel.app/api/v1/order", {
        method: "POST",
        headers: {
